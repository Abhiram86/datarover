...
>(
  (
    { value, onChange, onKeyDown, disabled, onSubmit, isStreaming, onCancel },
    ref,
  ) => {
    return (
      <div className="relative flex items-end gap-2 bg-neutral-strong/5 rounded-xl border border-neutral-strong/10 p-2 focus-within:border-neutral-strong/20 transition-all">
        ...
        {isStreaming ? (
          <button
            type="button"
            onClick={onCancel}
            className="p-2 bg-neutral-strong text-white rounded-lg hover:bg-red-900 transition-all mb-0.5"
          >
